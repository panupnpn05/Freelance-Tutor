    ...
    try {
      try {
        const response = await fetch(
          process.env.NEXT_PUBLIC_CREATE_REQUEST_TUTOR_API,
          {
            method: "POST",
            headers: {
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: 'url("/Image/photo1.avif")' }}
      >
        <div className="mt-8">
          <form
          ...
          >
            ...
            {openOther && (
              <div>
                <label className="block text-gray-700 mb-2 mt-1">Other subject</label>
                <input
                  type="text"
                  name="email"
